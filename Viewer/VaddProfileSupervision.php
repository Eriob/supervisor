            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-6">
                        <form class="form-horizontal" name="register_form" method="POST" action="index.php?index=addProfileSupervision">
                            ...
                            <button type="submit" value="send" class="btn btn-primary pull-left">Valid profile</button>
                        </div>
