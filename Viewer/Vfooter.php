...
$.get("index.php?index=explore" , {ip:ip} ).done(function (data)
  {
    ...
    window.open('/var/www/supervisor/Viewer/Explored/hostname_'+ip+'.html','Informations','toolbar=no, menubar=no, scrollbars=no, top=100, left=200, width=300, height=200');
